#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# coded by Zikri Adetya
# reedit & translate to indonesia by Zikri
import os
import re 
import time
import json
...
def masuk():
        ...
        print("Login Menggunakan Cookies, Bukan Email dan Password")
        try:
...
if __name__ == '__main__':
        try:
                ...
                print('\033[1;37m/ /___||   \\|      \ ||')
                print('\033[1;34m=========================')
                print('\033[1;33mAuthor: \033[1;36mZikriAdetya')
                print('\033[1;33mRe edit&Translate: \033[1;36mZikri')
                print('\033[1;34m=========================')
